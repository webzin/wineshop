...
CREATE TABLE `chalan` (
  ...
  `store_id` int(11) DEFAULT NULL,
  `chalan_no` int(25) DEFAULT NULL,
  `chalan_file` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Data for the table `chalan` */
...
CREATE TABLE `stock_inventory` (
  ...
  `in_out` char(10) DEFAULT NULL,
  `chalan_no` varchar(255) DEFAULT NULL,
  `sale_type` char(10) DEFAULT NULL,
...
insert  into `stock_inventory`(`id`,`store_id`,`date`,`item_id`,`qty`,`in_out`,`chalan_no`,`sale_type`,`depo_user_id`,`store_user_id`,`store_accepted`) values (1,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(2,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(3,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(4,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(5,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(6,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(7,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(8,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(9,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(10,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(11,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(12,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(13,3,'2020-06-01',2,11,NULL,NULL,NULL,11,NULL,'N'),(14,0,'2020-06-01',4,11,NULL,NULL,NULL,11,NULL,'N'),(15,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(16,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(17,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(18,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(19,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(20,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(21,0,'2020-06-01',0,0,NULL,NULL,NULL,11,NULL,'N'),(22,2,'2020-06-01',3,11,NULL,NULL,NULL,11,NULL,'N'),(23,3,'2020-06-01',2,11,NULL,NULL,NULL,11,NULL,'N'),(24,0,'2020-06-01',4,11,NULL,NULL,NULL,11,NULL,'N'),(25,1,'2020-06-01',2,11,NULL,NULL,NULL,11,NULL,'N');
...
insert  into `variants_type`(`id`,`name`) values (13,'Arist'),(1,'Beer'),(11,'Brandy'),(8,'Breezer'),(10,'Gin'),(6,'Red Wine'),(4,'Rum'),(9,'Soctch'),(15,'ter'),(14,'terr'),(2,'Vodka'),(3,'Whisky'),(7,'White Wine'),(5,'Wine'),(12,'Wine Fine');
