                                ...
                                <form id="additem">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" name="from_store" id="from_store"  required>
                                                <?php echo GetCombo("From Store","stores","id","name","","id","$store_id") ?>
                                               </select>
                                            </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" name="to_store" id="to_store"  required>
                                               <?php echo GetCombo("To Store","stores","id","name","","id","$store_id") ?> 
                                               </select>
                                            </div>
                                    ...
                                    <div id="dynamic_field">
                                     <div class="row">
                                        ...
                                        <input required type="text" class="form-control" placeholder="Remarks" name="remark[]" id="remark" value="<?php echo $remark; ?>">
